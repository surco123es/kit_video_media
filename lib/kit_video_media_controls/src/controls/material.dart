...
import 'package:kit_video_media/kit_video_media_controls/src/controls/methods/video_state.dart';
import 'package:kit_video_media/kit_video_media_controls/src/controls/extensions/duration.dart';
import 'package:kit_video_media/kit_video_media_controls/src/controls/widgets/video_controls_theme_data_injector.dart';
...
class _MaterialVideoControlsState extends State<_MaterialVideoControls> {
  ...
  void initState() {
    ...
    Future.microtask(() async {
      try {
        _brightnessValue = await ScreenBrightness.instance.system;
