...
import 'package:kit_video_media/kit_video_media_controls/kit_video_media_controls.dart';

import 'package:kit_video_media/src/subtitle/subtitle_view.dart';
import 'package:kit_video_media/kit_video_media_controls/kit_video_media_controls.dart'
    as kit_video_media_controls;
import 'package:kit_video_media/src/utils/dispose_safe_notifer.dart';

import 'package:kit_video_media/src/utils/wakelock.dart';
import 'package:kit_video_media/src/video_view_parameters.dart';
import 'package:kit_video_media/src/video_controller/video_controller.dart';
import 'package:kit_video_media/src/video_controller/platform_video_controller.dart';
...
class Video extends StatefulWidget {
  ...
  const Video({
    ...
    this.controls = kit_video_media_controls.AdaptiveVideoControls,
    this.wakelock = true,
...
class VideoState extends State<Video> with WidgetsBindingObserver {
  ...
  // Public API:
  bool isFullscreen() {
    return kit_video_media_controls.isFullscreen(_contextNotifier.value!);
  }

  Future<void> enterFullscreen() {
    return kit_video_media_controls.enterFullscreen(_contextNotifier.value!);
  }

  Future<void> exitFullscreen() {
    return kit_video_media_controls.exitFullscreen(_contextNotifier.value!);
  }

  Future<void> toggleFullscreen() {
    return kit_video_media_controls.toggleFullscreen(_contextNotifier.value!);
  }
  ...
  void didChangeDependencies() {
    _videoViewParametersNotifier =
        kit_video_media_controls.VideoStateInheritedWidget.maybeOf(
              context,
  ...
  @override
  Widget build(BuildContext context) {
    return kit_video_media_controls.VideoStateInheritedWidget(
