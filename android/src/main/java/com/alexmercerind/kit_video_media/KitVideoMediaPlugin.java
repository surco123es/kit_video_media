 ...
 * KitVideoMediaPlugin
 */
public class KitVideoMediaPlugin implements FlutterPlugin, MethodCallHandler, ActivityAware {
    ...
    public void onAttachedToActivity(@NonNull ActivityPluginBinding activityPluginBinding) {
        synchronized (lock) {
            KitVideoMediaPlugin.activity = activityPluginBinding.getActivity();

            if (videoOutputManager == null) {
                if (KitVideoMediaPlugin.activity != null && channel != null && textureRegistry != null) {
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
        synchronized (lock) {
            channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "controller/kit_video_media");
