...
public class VideoOutput {
    ...
    VideoOutput(long handle, MethodChannel channelReference, TextureRegistry textureRegistryReference) {
        ...
        try {
            ...
            throw new RuntimeException("Failed to initialize com.alexmercerind.kit_video_media.VideoOutput.");
        }
        ...
        try {
            ...
            Log.i("media_kit", String.format(Locale.ENGLISH, "com.alexmercerind.kit_video_media.VideoOutput: id = %d", id));
        } catch (Throwable e) {
            e.printStackTrace();
        }
    }
    ...
    private FlutterJNI getFlutterJNIReference() {
        try {
            ...
            if (view == null) {
                view = KitVideoMediaPlugin.activity.findViewById(FlutterActivity.FLUTTER_VIEW_ID);
            }
            // io.flutter.embedding.android.FlutterFragmentActivity
            if (view == null) {
                final FrameLayout layout = (FrameLayout) KitVideoMediaPlugin.activity.findViewById(FlutterFragmentActivity.FRAGMENT_CONTAINER_ID);
